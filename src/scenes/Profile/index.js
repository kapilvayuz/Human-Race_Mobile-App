...
const Renderfunctiontwo = (props) => {
    // const [set, setStore] = useState("");
    // const Avneet = async () => {
    //     const userToken = await AsyncStorage.getItem('userToken');
    //     console.log(userToken)
    //     let url = 'https://stormy-ravine-48948.herokuapp.com/challenge/all'
    //     fetch(url, {
    //         method: "GET",
    //         headers: {
    ...
    //             console.log(data.challData)
    //             console.log(props.id)
    //             const value = data.challData.filter(data => data._id == String(props.id))
    //             console.log(value)
    ...
    return (
        ...
        //                 <View >
        //                     <Video source={{ uri: `https://stormy-ravine-48948.herokuapp.com/static/${item.video_name}` }} />
    ...
    return (
        <View style={{ backgroundColor: "white" }}>
            <ScrollView>
                ...
                <View style={{ display: "flex", flexDirection: "row", marginLeft: "5%" }}>
                    ...
                    <View >
                        ...
                        <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-around", marginTop: "5%", width: "80%" }} >
                            ...
                            <Icon size={25} name="play" color="#28E0E0" />
                            <Entypo
                ...
                {toggle == 2 ? <Renderfunctiontwo id={id} /> : null}
